...
MODELS = [
    # {
    #     "name": "100k",
    #     "weights": Path('/Users/jihunjang/workspace/ust/fall-detection/src/v1/result/train_ins_100k_seed32/weights/best.pt'),
    #     "classes": [1],
    # },
    # {
    #     "name": "10k",
    #     "weights": Path('/Users/jihunjang/workspace/ust/fall-detection/src/v1/result/train_ins_10k_seed32/weights/best.pt'),
    #     "classes": [1],
    # },
    {
        "name": "5k",
