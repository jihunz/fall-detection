...
# ============================================================================
# 설정: 평가할 모델들 (Train Weights - Image Based)
# ============================================================================
MODELS = [
    {
        "name": "100k",
...
OUTPUT_ROOT = Path("/Users/jihunjang/workspace/ust/fall-detection/src/metrics/kisa_person_train")
...
TITLE = "FT based on Images - KISA Overseas Person"
...
def run_val() -> Dict[str, Dict[str, float]]:
    ...
    print(f"\n{'='*80}")
    print(f"Running validation on {len(MODELS)} models (Train Weights)")
    print(f"{'='*80}\n")
