...
FINETUNED_WEIGHT_DIR = 'gopr_250'
RESUME_WEIGHTS = Path(f'/src/train-v1/result/{FINETUNED_WEIGHT_DIR}/weights/last.pt')
DATA_CFG = BASE_DIR / ('yamls/data_gopr_250.yaml')
...
def run_train(resume: bool | None = None) -> None:
    ...
    model.train(
        ...
        name=FINETUNED_WEIGHT_DIR,
        verbose=True,
    )


if __name__ == '__main__':
    # run_train(False) # 초기 학습
    run_train()
